...
prod <- filter(ARMS, str_detect(AGG_LEVEL_DESC, "^NATIONAL"), str_detect(DOMAIN_DESC, "TOTAL"), 
...
# Acres Planted
acres <- filter(prod, str_detect(SHORT_DESC, "HARVESTED"), str_detect(AGG_LEVEL_DESC, "^NATIONAL"), 
                str_detect(SHORT_DESC, "FIELD CROP TOTALS"), YEAR >= 1998 & YEAR < 2017)

acres_c <- filter(prod, str_detect(SHORT_DESC, "HARVESTED"), str_detect(AGG_LEVEL_DESC, "^NATIONAL"), 
...
acres_s <- filter(prod, str_detect(SHORT_DESC, "HARVESTED"), str_detect(AGG_LEVEL_DESC, "^NATIONAL"), 
